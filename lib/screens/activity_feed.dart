...
class ActivityFeedItem extends StatelessWidget {
  ...
  factory ActivityFeedItem.fromDocument(DocumentSnapshot document) {
    ...
    return ActivityFeedItem(
      ...
      userId: (data as dynamic)['userId'],
      type: (data as dynamic)['type'],
      mediaUrl: (data as dynamic)['mediaUrl'],
      mediaId: (data as dynamic)['postId'],
      userProfileImg: (data as dynamic)['userProfileImg'],
      commentData: (data as dynamic)["commentData"],
    );
  }
